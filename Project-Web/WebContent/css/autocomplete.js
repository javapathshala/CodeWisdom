...
function normal(selectedIndex,responseList)
{
	...
	//responseList = content.split("|");
	var str="";
//	if(responseList.length > 0 && content.match("[a-zA-Z0-9]"))
//	{
...
//	qvalue = qvalue.replace(reg,'\\+');
	...
	/*if(responseList.length > 0 && response.match("[a-zA-Z0-9]"))
	{
		for(i=0;i<responseList.length;i++)
		{
			str=responseList[i];

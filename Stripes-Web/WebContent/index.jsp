...
<html>
  ...
  <body>
    ...
    <stripes:form action="/com/application/action/Calculator.action" focus="">
        <stripes:errors/>
        <table>
            <tr>
                <td>Number 1:</td>
            ...
            <tr>
                ...
                <tr>
                	<td>
                	<!-- stripes:link href="/com/application/Calculator.action" event="showScreen"-->
                	<a href="http://localhost:9081/Strips-Web/com/application/action/Calculator.action?showScreen=&comp=Steria">
                	Dimit
                	</a>
                	<!-- /stripes:link-->

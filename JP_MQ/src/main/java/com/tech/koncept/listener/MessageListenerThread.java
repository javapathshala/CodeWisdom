...
public class MessageListenerThread implements Runnable, MessageListener {
	...
	public static void main(String[] args) {
		...
		try {
			...
			factory.setChannel("MQ.CLT.BIB.SSL");
			...
			apiIn = (MQQueue) session.createQueue("BIB.BIB.API.REQ");
